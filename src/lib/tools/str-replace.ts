...
export const buildStrReplaceTool = (fileSystem: VirtualFileSystem) => {
  return tool({
    description:
      "View, create, or edit files in the virtual file system. Use create to make new files, str_replace to modify existing content, insert to add lines, and view to read files.",
